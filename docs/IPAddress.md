...
`func NewIPAddress(id int32, url string, display string, family AggregateFamily, address string, natOutside []NestedIPAddress, created NullableTime, lastUpdated NullableTime, ) *IPAddress`
