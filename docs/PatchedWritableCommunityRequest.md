...
`func (o *PatchedWritableCommunityRequest) GetTenant() int32`

GetTenant returns the Tenant field if non-nil, zero value otherwise.

### GetTenantOk

`func (o *PatchedWritableCommunityRequest) GetTenantOk() (*int32, bool)`
...
`func (o *PatchedWritableCommunityRequest) SetTenant(v int32)`
