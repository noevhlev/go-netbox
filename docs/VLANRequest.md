...
`func (o *VLANRequest) GetStatus() CommunityStatusValue`

GetStatus returns the Status field if non-nil, zero value otherwise.

### GetStatusOk

`func (o *VLANRequest) GetStatusOk() (*CommunityStatusValue, bool)`
...
`func (o *VLANRequest) SetStatus(v CommunityStatusValue)`
