...
`func (o *WritableCommunityRequest) GetTenant() int32`

GetTenant returns the Tenant field if non-nil, zero value otherwise.

### GetTenantOk

`func (o *WritableCommunityRequest) GetTenantOk() (*int32, bool)`
...
`func (o *WritableCommunityRequest) SetTenant(v int32)`
