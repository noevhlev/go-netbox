...
// JournalEntryKindValue * `info` - Info * `success` - Success * `warning` - Warning * `danger` - Danger * `system_notification` - System Notification
...
const (
	...
	JOURNALENTRYKINDVALUE_SYSTEM_NOTIFICATION JournalEntryKindValue = "system_notification"
)
