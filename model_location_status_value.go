...
// LocationStatusValue * `planned` - Available * `staged` - Reserved * `active` - Active * `decommissioning` - Decommissioning * `retired` - Retired
type LocationStatusValue string

// List of Location_status_value
const (
	LOCATIONSTATUSVALUE_PLANNED         LocationStatusValue = "planned"
	LOCATIONSTATUSVALUE_STAGED          LocationStatusValue = "staged"
