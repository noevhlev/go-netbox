...
// checks if the NestedInventoryItemGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NestedInventoryItemGroup{}

// NestedInventoryItemGroup Represents an object related through a ForeignKey field. On write, it accepts a primary key (PK) value or a dictionary of attributes which can be used to uniquely identify the related object. This class should be subclassed to return a full representation of the related object on read.
type NestedInventoryItemGroup struct {
	Id                   int32  `json:"id"`
	Url                  string `json:"url"`
...
type _NestedInventoryItemGroup NestedInventoryItemGroup
...
func (o NestedInventoryItemGroup) MarshalJSON() ([]byte, error) {
...
func (o NestedInventoryItemGroup) ToMap() (map[string]interface{}, error) {
...
func (o *NestedInventoryItemGroup) UnmarshalJSON(data []byte) (err error) {
	...
	varNestedInventoryItemGroup := _NestedInventoryItemGroup{}

	err = json.Unmarshal(data, &varNestedInventoryItemGroup)

	if err != nil {
		return err
	}

	*o = NestedInventoryItemGroup(varNestedInventoryItemGroup)
...
type NullableNestedInventoryItemGroup struct {
	value *NestedInventoryItemGroup
	isSet bool
}

func (v NullableNestedInventoryItemGroup) Get() *NestedInventoryItemGroup {
	return v.value
}

func (v *NullableNestedInventoryItemGroup) Set(val *NestedInventoryItemGroup) {
	v.value = val
	v.isSet = true
}

func (v NullableNestedInventoryItemGroup) IsSet() bool {
	return v.isSet
}

func (v *NullableNestedInventoryItemGroup) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNestedInventoryItemGroup(val *NestedInventoryItemGroup) *NullableNestedInventoryItemGroup {
	return &NullableNestedInventoryItemGroup{value: val, isSet: true}
}

func (v NullableNestedInventoryItemGroup) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNestedInventoryItemGroup) UnmarshalJSON(src []byte) error {
	v.isSet = true
