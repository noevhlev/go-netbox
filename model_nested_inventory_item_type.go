...
// checks if the NestedInventoryItemType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NestedInventoryItemType{}

// NestedInventoryItemType Represents an object related through a ForeignKey field. On write, it accepts a primary key (PK) value or a dictionary of attributes which can be used to uniquely identify the related object. This class should be subclassed to return a full representation of the related object on read.
type NestedInventoryItemType struct {
	Id                   int32              `json:"id"`
	Url                  string             `json:"url"`
...
type _NestedInventoryItemType NestedInventoryItemType
...
func (o NestedInventoryItemType) MarshalJSON() ([]byte, error) {
...
func (o NestedInventoryItemType) ToMap() (map[string]interface{}, error) {
...
func (o *NestedInventoryItemType) UnmarshalJSON(data []byte) (err error) {
	...
	varNestedInventoryItemType := _NestedInventoryItemType{}

	err = json.Unmarshal(data, &varNestedInventoryItemType)

	if err != nil {
		return err
	}

	*o = NestedInventoryItemType(varNestedInventoryItemType)
...
type NullableNestedInventoryItemType struct {
	value *NestedInventoryItemType
	isSet bool
}

func (v NullableNestedInventoryItemType) Get() *NestedInventoryItemType {
	return v.value
}

func (v *NullableNestedInventoryItemType) Set(val *NestedInventoryItemType) {
	v.value = val
	v.isSet = true
}

func (v NullableNestedInventoryItemType) IsSet() bool {
	return v.isSet
}

func (v *NullableNestedInventoryItemType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNestedInventoryItemType(val *NestedInventoryItemType) *NullableNestedInventoryItemType {
	return &NullableNestedInventoryItemType{value: val, isSet: true}
}

func (v NullableNestedInventoryItemType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNestedInventoryItemType) UnmarshalJSON(src []byte) error {
	v.isSet = true
