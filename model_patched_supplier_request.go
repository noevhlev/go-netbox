...
// checks if the PatchedSupplierRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedSupplierRequest{}

// PatchedSupplierRequest Adds support for custom fields and tags.
type PatchedSupplierRequest struct {
...
type _PatchedSupplierRequest PatchedSupplierRequest
...
func (o PatchedSupplierRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedSupplierRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedSupplierRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedSupplierRequest := _PatchedSupplierRequest{}

	err = json.Unmarshal(data, &varPatchedSupplierRequest)

	if err != nil {
		return err
	}

	*o = PatchedSupplierRequest(varPatchedSupplierRequest)
...
type NullablePatchedSupplierRequest struct {
	value *PatchedSupplierRequest
	isSet bool
}

func (v NullablePatchedSupplierRequest) Get() *PatchedSupplierRequest {
	return v.value
}

func (v *NullablePatchedSupplierRequest) Set(val *PatchedSupplierRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedSupplierRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedSupplierRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedSupplierRequest(val *PatchedSupplierRequest) *NullablePatchedSupplierRequest {
	return &NullablePatchedSupplierRequest{value: val, isSet: true}
}

func (v NullablePatchedSupplierRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedSupplierRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
