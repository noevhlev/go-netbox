...
type PatchedWritableBGPSessionRequest struct {
	...
	LocalAddress         *int32                 `json:"local_address,omitempty"`
	RemoteAddress        *int32                 `json:"remote_address,omitempty"`
...
// SetLocalAddress gets a reference to the given int32 and assigns it to the LocalAddress field.
...
// SetRemoteAddress gets a reference to the given int32 and assigns it to the RemoteAddress field.
...
// SetRemoteAs gets a reference to the given int32 and assigns it to the RemoteAs field.
