...
// PatchedWritableRackRequestStatus * `available` - Available * `reserved` - Reserved * `planned` - Paid Reserve * `preparing` - Preparing * `active` - Active * `deprecated` - Deprecated
...
const (
	...
	PATCHEDWRITABLERACKREQUESTSTATUS_PREPARING  PatchedWritableRackRequestStatus = "preparing"
