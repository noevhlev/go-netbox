...
type PrefixListRule struct {
	...
	Prefix               NullableNestedPrefix    `json:"prefix,omitempty"`
...
// SetPrefix gets a reference to the given NullableNestedPrefix and assigns it to the Prefix field.
