...
const (
	...
	VIRTUALMACHINEWITHCONFIGCONTEXTSTATUSLABEL_MAINTENANCE     VirtualMachineWithConfigContextStatusLabel = "Maintenance"
	VIRTUALMACHINEWITHCONFIGCONTEXTSTATUSLABEL_TESTING         VirtualMachineWithConfigContextStatusLabel = "Testing"
)
