...
// checks if the WritableInventoryItemGroupRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WritableInventoryItemGroupRequest{}

// WritableInventoryItemGroupRequest Adds support for custom fields and tags.
type WritableInventoryItemGroupRequest struct {
...
type _WritableInventoryItemGroupRequest WritableInventoryItemGroupRequest
...
func NewWritableInventoryItemGroupRequest(name string) *WritableInventoryItemGroupRequest {
	this := WritableInventoryItemGroupRequest{}
	this.Name = name
	return &this
}
...
func (o *WritableInventoryItemGroupRequest) SetParentNil() {
	o.Parent.Set(nil)
}
...
func (o WritableInventoryItemGroupRequest) MarshalJSON() ([]byte, error) {
...
func (o WritableInventoryItemGroupRequest) ToMap() (map[string]interface{}, error) {
...
func (o *WritableInventoryItemGroupRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varWritableInventoryItemGroupRequest := _WritableInventoryItemGroupRequest{}

	err = json.Unmarshal(data, &varWritableInventoryItemGroupRequest)

	if err != nil {
		return err
	}

	*o = WritableInventoryItemGroupRequest(varWritableInventoryItemGroupRequest)
...
type NullableWritableInventoryItemGroupRequest struct {
	value *WritableInventoryItemGroupRequest
	isSet bool
}

func (v NullableWritableInventoryItemGroupRequest) Get() *WritableInventoryItemGroupRequest {
	return v.value
}

func (v *NullableWritableInventoryItemGroupRequest) Set(val *WritableInventoryItemGroupRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableWritableInventoryItemGroupRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableWritableInventoryItemGroupRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWritableInventoryItemGroupRequest(val *WritableInventoryItemGroupRequest) *NullableWritableInventoryItemGroupRequest {
	return &NullableWritableInventoryItemGroupRequest{value: val, isSet: true}
}

func (v NullableWritableInventoryItemGroupRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWritableInventoryItemGroupRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
