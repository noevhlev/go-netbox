...
// checks if the WritablePurchaseRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WritablePurchaseRequest{}

// WritablePurchaseRequest Adds support for custom fields and tags.
type WritablePurchaseRequest struct {
...
type _WritablePurchaseRequest WritablePurchaseRequest
...
func (o *WritablePurchaseRequest) SetDateNil() {
	o.Date.Set(nil)
}
...
func (o WritablePurchaseRequest) MarshalJSON() ([]byte, error) {
...
func (o WritablePurchaseRequest) ToMap() (map[string]interface{}, error) {
...
func (o *WritablePurchaseRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varWritablePurchaseRequest := _WritablePurchaseRequest{}

	err = json.Unmarshal(data, &varWritablePurchaseRequest)

	if err != nil {
		return err
	}

	*o = WritablePurchaseRequest(varWritablePurchaseRequest)
...
type NullableWritablePurchaseRequest struct {
	value *WritablePurchaseRequest
	isSet bool
}

func (v NullableWritablePurchaseRequest) Get() *WritablePurchaseRequest {
	return v.value
}

func (v *NullableWritablePurchaseRequest) Set(val *WritablePurchaseRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableWritablePurchaseRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableWritablePurchaseRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWritablePurchaseRequest(val *WritablePurchaseRequest) *NullableWritablePurchaseRequest {
	return &NullableWritablePurchaseRequest{value: val, isSet: true}
}

func (v NullableWritablePurchaseRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWritablePurchaseRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
